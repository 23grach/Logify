...
describe('Logify Plugin Functional Tests', () => {
    ...
    describe('Change Detection Logic', () => {
        test('should identify new elements', () => {
            ...
            const added = currentElements.filter(curr => !previousElements.some(prev => prev.id === curr.id));
        ...
        test('should identify removed elements', () => {
            ...
            const removed = previousElements.filter(prev => !currentElements.some(curr => curr.id === prev.id));
    ...
    describe('Performance Monitoring', () => {
        test('should track operation performance', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    describe('Error Handling', () => {
        test('should handle async operation errors', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    describe('Integration Tests', () => {
        test('should handle full workflow: collect, compare, and update', () => __awaiter(void 0, void 0, void 0, function* () {
            // Mock initial data
            ...
            // Compare
            const added = currentElements.filter(curr => !initialElements.some(prev => prev.id === curr.id));
            const modified = currentElements.filter(curr => {
    ...
    describe('Edge Cases', () => {
        ...
        test('should handle malformed data gracefully', () => {
            ...
            const validElements = malformedData.filter(item => item &&
                typeof item === 'object' &&
    ...
    describe('Component Properties Handling', () => {
        test('should handle variant properties correctly', () => {
            ...
            expect((_a = componentWithVariants.variantProperties) === null || _a === void 0 ? void 0 : _a.Size).toBe('Large');
        });
    ...
    describe('Error Scenarios', () => {
        ...
        test('should handle API errors during font loading', () => __awaiter(void 0, void 0, void 0, function* () {
            mockFigma.loadFontAsync.mockRejectedValue(new Error('Font not available'));
            try {
                yield mockFigma.loadFontAsync({ family: 'NonExistent', style: 'Regular' });
            }
            catch (error) {
                expect(error).toBeInstanceOf(Error);
                expect(error.message).toBe('Font not available');
            }
        }));
    });
    ...
    describe('Extended Properties Tracking', () => {
        ...
        test('should generate layout hash for auto-layout properties', () => {
            ...
            const modifiedProps = Object.assign(Object.assign({}, layoutProps), { itemSpacing: 24 });
        ...
        test('should generate geometry hash for size and position', () => {
            ...
            const resizedProps = Object.assign(Object.assign({}, geometryProps), { width: 150 });
        ...
        test('should generate appearance hash for visual properties', () => {
            ...
            const hiddenProps = Object.assign(Object.assign({}, appearanceProps), { visible: false });
        ...
        test('should generate typography hash for text properties', () => {
            ...
            const largerProps = Object.assign(Object.assign({}, typographyProps), { fontSize: 20 });
        ...
        test('should generate border properties hash', () => {
            ...
            const thickerProps = Object.assign(Object.assign({}, borderProps), { strokeWeight: 4 });
    ...
    describe('Variables Support', () => {
        ...
        test('should process variable definition hashing', () => {
            ...
            const modifiedDef = Object.assign(Object.assign({}, variableCollectionDef), { defaultModeId: 'dark' });
    ...
    describe('Comprehensive Integration Tests', () => {
        test('should handle full element lifecycle with extended properties', () => {
            ...
            const extendedElement = Object.assign(Object.assign({}, initialElement), { layoutHash: 'layout-123', geometryHash: 'geo-456', appearanceHash: 'app-789' });
            // Step 3: Modify properties
            const modifiedElement = Object.assign(Object.assign({}, extendedElement), { name: 'Primary Button Component', layoutHash: 'layout-modified', geometryHash: 'geo-456' // Geometry unchanged
             });
    ...
    describe('Component Set Filtering and Display Logic', () => {
        ...
        function mockFilterRedundantComponentSetChanges(changes) {
            const modifiedComponentSetIds = new Set();
            const modifiedComponentParentNames = new Set();
            ...
            return Object.assign(Object.assign({}, changes), { modified: filteredModified });
        }
        function mockUpdateComponentDisplayNames(changes) {
            const updatedModified = changes.modified.map((element) => {
                if (element.type === 'component' && element.parentName) {
                    // Update the name to show "Set - Component" format
                    return Object.assign(Object.assign({}, element), { name: `${element.parentName} - ${element.name}` });
                }
                return element;
            });
            return Object.assign(Object.assign({}, changes), { modified: updatedModified });
        }
        ...
        test('should handle complex component set filtering scenario', () => {
            ...
            expect((_a = finalChanges.modified.find((item) => item.id === 'comp1')) === null || _a === void 0 ? void 0 : _a.name).toBe('Button Set - Primary');
            expect((_b = finalChanges.modified.find((item) => item.id === 'comp2')) === null || _b === void 0 ? void 0 : _b.name).toBe('Button Set - Secondary');
            expect((_c = finalChanges.modified.find((item) => item.id === 'set2')) === null || _c === void 0 ? void 0 : _c.name).toBe('Card Set');
            expect(finalChanges.modified.find((item) => item.id === 'set1')).toBeUndefined(); // Should be filtered out
        });
    });
    describe('Nested Content Hash Logic', () => {
        ...
        function mockTraverseNodeProperties(node) {
            const result = [];
        ...
        function mockCalculateNestedContentHash(node) {
    ...
    describe('Element Display Formatting', () => {
        ...
        function mockFormatElementForDisplay(element) {
            const typeEmojis = {
                component: '🧩',
                componentSet: '📦',
                textStyle: '📝',
